...
<div id="page">
    ...
    <div class="page-inner">
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            <li><a href="<c:url value="/resources/features.html"/>">Features</a></li>
                            <li><a href="<c:url value="/resources/tour.html"/>">Tour</a></li>
                            ...
                            <li><a href="<c:url value="/resources/pricing.html"/>">Pricing</a></li>
                            <li><a href="<c:url value="/resources/contact.html"/>">Contact</a></li>
        ...
        <header id="gtco-header" class="gtco-cover" role="banner"
                style="background-image: url(<c:url value="/resources/images/img_4.jpg"/>)">
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="<c:url value="/resources/images/img_2.jpg"/>" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="<c:url value="/resources/images/img_2.jpg"/>" alt="Image"
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="<c:url value="/resources/images/img_3.jpg"/>" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="<c:url value="/resources/images/img_3.jpg"/>" alt="Image"
                                     class="img-responsive">
                            </figure>
                            <div class="fh5co-text">
                                <h2>Constructive heading</h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="<c:url value="/resources/images/img_4.jpg"/>" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="<c:url value="/resources/images/img_4.jpg"/>" alt="Image"
                                     class="img-responsive">
                            </figure>
                            <div class="fh5co-text">
                                <h2>Constructive heading</h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="<c:url value="/resources/images/img_1.jpg"/>" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="<c:url value="/resources/images/img_1.jpg"/>" alt="Image"
                                     class="img-responsive">
                            </figure>
                            <div class="fh5co-text">
                                <h2>Constructive heading</h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="<c:url value="/resources/images/img_5.jpg"/>" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="<c:url value="/resources/images/img_5.jpg"/>" alt="Image"
                                     class="img-responsive">
                            </figure>
                            <div class="fh5co-text">
                                <h2>Constructive heading</h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="<c:url value="/resources/images/img_6.jpg"/>" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="<c:url value="/resources/images/img_6.jpg"/>" alt="Image"
                                     class="img-responsive">
                            </figure>
                            <div class="fh5co-text">
                                <h2>Constructive heading</h2>
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="owl-carousel owl-carousel-carousel">
                        <div class="item">
                            <a href="#"><img src="<c:url value="/resources/images/img_1.jpg"/>"
                                             alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="<c:url value="/resources/images/img_2.jpg"/>"
                                             alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="<c:url value="/resources/images/img_3.jpg"/>"
                                             alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="<c:url value="/resources/images/img_4.jpg"/>"
                                             alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                    </div>
                </div>
